...
t2_60min = log1p.(totalData[:,hourCells])

using JLD2
futureExpressionPredictions = load_object("rpe_24hourPredictions_Ensemble_2.jld2")
...
R"""
save.image("ccPreds_Ensemble.RData")
"""

R"""
library(tricycle)
load("ccPreds_Ensemble.RData")
...
write.csv(iniProj, "initialDataTricycleScores_Ensemble.csv")
write.csv(ccData, "predExpTricycleScores_Ensemble.csv")
"""
