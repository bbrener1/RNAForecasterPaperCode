...
using JLD2
save_object("totalCounts_RPE_1hrLab.jld2", t2_60min)
...
futureExpressionPredictions = predictCellFutures(trainedForecaster[1][1], t2_60min, 72,
enforceMaxPred = false, useGPU = true)

save_object("rpe_72hour_Predictions_noMaxPred_noEns.jld2", futureExpressionPredictions)
