...
using JLD2
futureExpressionPredictions = load_object("rpe_72hour_Predictions_noMaxPred_noEns.jld2")

# rpe_72hour_Predictions_Ensemble_noMaxPred.jld2
# rpe_72hour_Predictions_maxPred_noEns.jld2
# rpe_72hour_Predictions_noMaxPred_noEns.jld2
...
R"""
save.image("ccPreds_NMP_NE.RData")
"""

#"ccPreds_Ensemble_NMP.RData"
#"ccPreds_MP_NE.RData"
#"ccPreds_NMP_NE.RData"

R"""
library(tricycle)
load("ccPreds_NMP_NE.RData")
...
write.csv(iniProj, "initialDataTricycleScores_NMP_NE.csv")
write.csv(ccData, "predExpTricycleScores_NMP_NE.csv")
"""
